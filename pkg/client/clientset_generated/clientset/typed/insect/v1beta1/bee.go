...
type BeeInterface interface {
	Create(*v1beta1.Bee) (*v1beta1.Bee, error)
	Update(*v1beta1.Bee) (*v1beta1.Bee, error)
	UpdateStatus(*v1beta1.Bee) (*v1beta1.Bee, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Bee, error)
	List(opts v1.ListOptions) (*v1beta1.BeeList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Bee, err error)
	BeeExpansion
}
...
func newBees(c *InsectV1beta1Client, namespace string) *bees {
	return &bees{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *bees) Get(name string, options v1.GetOptions) (result *v1beta1.Bee, err error) {
	result = &v1beta1.Bee{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bees").
...
func (c *bees) List(opts v1.ListOptions) (result *v1beta1.BeeList, err error) {
	result = &v1beta1.BeeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bees").
...
func (c *bees) Create(bee *v1beta1.Bee) (result *v1beta1.Bee, err error) {
	result = &v1beta1.Bee{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bees").
...
func (c *bees) Update(bee *v1beta1.Bee) (result *v1beta1.Bee, err error) {
	result = &v1beta1.Bee{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bees").
...
func (c *bees) UpdateStatus(bee *v1beta1.Bee) (result *v1beta1.Bee, err error) {
	result = &v1beta1.Bee{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bees").
...
func (c *bees) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Bee, err error) {
	result = &v1beta1.Bee{}
